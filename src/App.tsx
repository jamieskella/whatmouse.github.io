...
function App() {
  return (
    <div className="flex flex-col space-y-16 max-w-screen-md px-4 md:px-8 mx-auto min-h-screen py-16">
  ...
  "description": {
    "tone": "edgy 1990s PlayStation ad",
          ...
          <p className="uppercase font-bold">
            ...
            Razer Viper, you're not even close. This is in a league [almost] of
            its own. You have just a few choices if you want an uncompromisingly
            exact and unapologetically raw mousing experience. And this is one
            of them.
          </p>
          ...
          <p className="uppercase">
            ...
            champions from the forgotten, there's no room for dead weight. Which
            is why every gram of unnecessary mass has been stripped away.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-6 md:pt-87 basis-1/2">
          <p className="uppercase">
            ...
            unadulterated connection to your game. No RGB. No frills. Just you,
